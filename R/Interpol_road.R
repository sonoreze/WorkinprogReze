...
library(pacman)
pacman::p_load(here,ggplot2,ggforce,ggthemes,thematic,plotly,mapview,scales,tidyr,dplyr,lubridate,stringr,forcats,rgdal,sp,sf,
...
lz.sk <- krige(leq_mean_corr  ~ 1, Pts_Reze_2154, sf_grd, var_sph.fit,nmin=1,nmax=10, maxdist =100) #maxdist =150
# MESSAGE
