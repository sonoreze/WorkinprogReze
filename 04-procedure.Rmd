...
```{r}
SPDF_sf <- st_as_sf(tags_table, coords = c("x", "y"), crs = 4326, agr = "constant", remove = F)
st_crs(SPDF_sf) <- 4326 #EPSG WGS84
SPDF_sf_2154 <- st_transform(SPDF_sf, 2154) #LAMBERT 93
st_write(SPDF_sf_2154, here("geo","Reze","pts_road_reze_2154.shp"), append=FALSE)

## -------------------------
#read layer shapefile
#PTS_ALL_2154 <- readOGR(dsn = here("geo"), layer = "PTS_ALL_2154_c") #Too much Lines
Pts_Reze_2154 <- st_read(here("geo","Reze","pts_road_reze_2154.shp"))
